# inference_udp.py - FIXED to match working infer_live.py pipeline
...
def main():
    ...
    stats = torch.load("./runs_ref/20260125_235217_ref/label_stats.pt", map_location="cpu", weights_only=True)
    ...
    model.load_state_dict(torch.load("./runs_ref/20260125_235217_ref/laser_net_best.pt", map_location=device, weights_only=True))
    model.eval()

    # ---- Open camera via V4L2 (EXACTLY as in infer_live.py) ----
    ...
    print("\nStarting inference (DIFF) + UDP send. Press 'q' to quit.")
