...
class LaserDataset(Dataset):
    ...
    Folder layout supported (your train2):
      <root>/
        seq1.csv ... seq5.csv
        seq1/seq1_1 1.tga, seq1_start 1.tga, ...
        seq2/seq2_0 1.tga, ...

    Returns per item:
      x: image tensor [3,H,W], normalized to [-1,1]
      y_norm: label tensor [2] normalized according to `label_norm`
      seq: sequence string ("seq1"...)
      y_raw: raw label tensor [2] (useful for diagnostics)
    """
