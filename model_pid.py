...
AZIMUTH_ISOTONIC_X = [
    -0.474, -0.273, -0.265, -0.214, -0.199,
    -0.178, -0.172, 0.058, 0.069, 0.207,
    0.225, 0.264, 0.310, 0.540, 0.586,
    0.590, 0.592, 0.673, 0.682, 0.692,
    0.699, 0.739, 0.743, 0.788, 0.802,
    0.821, 0.824, 0.824, 0.825, 0.870,
    0.903,
]

AZIMUTH_ISOTONIC_Y = [
    -0.903, -0.903, -0.700, -0.700, -0.550,
    -0.500, -0.380, -0.380, -0.317, -0.317,
    -0.000, -0.000, 0.158, 0.158, 0.200,
    0.200, 0.437, 0.437, 0.550, 0.550,
    0.600, 0.600, 0.843, 0.843, 1.090,
    1.090, 1.200, 1.225, 1.225, 1.350,
    1.450,
]

ELEVATION_ISOTONIC_X = [
    -0.268, -0.260, -0.249, -0.248, -0.248,
    -0.247, -0.245, -0.240, -0.239, -0.236,
    -0.231, -0.228, -0.228, -0.022, -0.022,
    0.087, 0.091, 0.104, 0.105, 0.106,
    0.108, 0.109, 0.111, 0.157, 0.164,
]

ELEVATION_ISOTONIC_Y = [
    -0.700, -0.700, -0.667, -0.667, -0.567,
    -0.567, -0.133, -0.133, -0.117, -0.117,
    0.050, 0.050, 0.060, 0.060, 0.085,
    0.085, 0.114, 0.114, 0.133, 0.133,
    0.400, 0.600, 0.708, 0.708, 0.900,
]
